# FNCS_MPICXX_TEST_PROGRAM
# ------------------------
# Create an MPI test program in C++.
AC_DEFUN([FNCS_MPICXX_TEST_PROGRAM], [
AC_LANG_PUSH([C++])
...
# FNCS_MPICXX_TEST_COMPILE
# ------------------------
# Attempt to compile a simple MPI program in C++.
AC_DEFUN([FNCS_MPICXX_TEST_COMPILE], [
AC_LANG_PUSH([C++])
FNCS_MPICXX_TEST_PROGRAM()
...
# FNCS_MPICXX_TEST_LINK
# ---------------------
# Attempt to link a simple MPI program in C++.
AC_DEFUN([FNCS_MPICXX_TEST_LINK], [
AC_LANG_PUSH([C++])
FNCS_MPICXX_TEST_PROGRAM()
